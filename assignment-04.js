...
const result2 = isLGSeven(numberInput);
// console.log(result2);
...
const result3 = findingBadData(ages);
// console.log(result3);

// The function gemsToDiamond() will take three numbers(integer) as parameters which are the gem point numbers of three friends of mine. The power of per gem point of the first friend equals to 21 diamonds, the power of per gem pointof the second friend equals to 32 diamonds and the power of per gem point of the third friend equals to 43 diamonds respectively. Now the function will find out the toal of the power of gem points of three friends and will find out  the number of diamonds mjultiplying the power with the points collectively. If the number of total diamonds is greater than or equals to double of 1000, the function will deduct 2000 diamonds from the total and return the rest number of diamonds. If the number of diamonds is less than double of 1000, it will simply return the number of diamonds calculated.

// Math.sign(-number) != true && Math.sign(number) != 0;
